...
class FilterComponentList extends Component {

    state = {
        selectedCarMake: null,

        selectedCarsMakeOption: carModels.cars,
    ...
    handleCarModelChange = selectedCarsModelOption => {
            ...
            console.log(`Option selected:`, selectedCarsModelOption.label);
    ...
    handleCarsYearMinChange = selectedCarsYearMinOption => {
        ...
        console.log(`Option selected:`, selectedCarsYearMinOption.label);
    }
    ...
    handleCarsYearMaxChange = selectedCarsYearMaxOption => {
        ...
        console.log(`Option selected:`, selectedCarsYearMaxOption.label);
    }
    ...
    handleCarLocationChange = selectedCarsLocationOption => {
        ...
        console.log(`Option selected:`, selectedCarsLocationOption.label);
    }
    ...
    handleCarsPriceMinChange = selectedCarsPriceMinOption => {
        ...
        console.log(`Option selected:`, selectedCarsPriceMinOption.value);
    }
    ...
    handleCarsPriceMaxChange = selectedCarsPriceMaxOption => {
        ...
        console.log(`Option selected:`, selectedCarsPriceMaxOption.value);
    }
    ...
    render() {
        ...
        return ( 
        < div >
        <div className="rounded mx-auto shadow-lg" style={selectorStyle}>
                <div className="col text-dark text-centre font-weight-bold" style={{marginTop:"5px"}}>
                    <Select value={this.state.selectedCarsMakeOption} onChange={this.handleCarMakeChange} options={carsMakeOption} placeholder={"Make"}/>
                </div>

                
                <div className = "col text-dark text-centre font-weight-bold" style={{marginTop:"5px"}}>
                    <Select value={this.state.selectedCarsModelOption} onChange={this.handleCarModelChange} options={carsModelOption} placeholder={"Model"}/>
                </div> 

                <div className = "col text-dark text-centre font-weight-bold" style={{marginTop:"5px"}}>
                    <Select value={this.state.selectedCarsYearMinOption} onChange={this.handleCarsYearMinChange} options={yearsOption} placeholder={"Year: From"}/>
                </div>

                < div className = "col text-dark text-centre font-weight-bold" style={{marginTop:"5px"}}>
                    <Select value={this.state.selectedCarsYearMaxOption} onChange={this.handleCarsYearMaxChange}options={yearsOption} placeholder={"Year: To"}/>
                </div>

                <div className = "col text-dark text-centre font-weight-bold"  style={{marginTop:"5px"}}>
                    <Select value={this.state.selectedCarsLocationOption} onChange={this.handleCarLocationChange} options={carsLocationOption} placeholder={"Location"}/>
                </div> 

                <div className = "col text-dark text-centre font-weight-bold" style={{marginTop:"5px"}}>
                    <Select value={this.state.selectedCarsPriceMinOption} onChange={this.handleCarsPriceMinChange} options={priceOptions} placeholder={"Price: Min"}/>
                </div>

                < div className = "col text-dark text-centre font-weight-bold" style={{marginTop:"5px"}}>
                    <Select value={this.state.selectedCarsPriceMaxOption} onChange={this.handleCarsPriceMaxChange}options={priceOptions} placeholder={"Price: Max"}/>
                </div>

                <div className="col text-center"  style={{marginTop:"5px", marginBottom:"5px"}}>
                     <Link to={`/listcars/${this.state.selectedCarsMakeOptionValue}/${this.state.selectedCarsModelOptionValue}/${this.state.selectedCarsLocationOptionValue}/${this.state.selectedCarsYearMinOptionValue}/${this.state.selectedCarsYearMaxOptionValue}/${this.state.selectedCarsPriceMinOptionValue}/${this.state.selectedCarsPriceMaxOptionValue}`} className="btn btn-custom btn-block text-dark text-centre font-weight-bold" role="button">
