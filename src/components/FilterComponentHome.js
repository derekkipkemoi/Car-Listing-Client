...
class FilterComponent extends Component {
  ...
  render() {
    ...
    return (
      ...
      >
        <div className="rounded shadow-lg" style={selectorStyle}>
          <div className="row">
            <div
              className="col-xm-6 col-md-3 text-dark text-centre font-weight-bold"
          ...
          <div className="row">
            <div
              className="col-md-3 text-dark text-centre font-weight-bold"
              style={{ marginTop: "10px" }}
            >
              <Select
            ...
            <div className="col-md-3 text-center" style={{ marginTop: "10px" }}>
              <Link
