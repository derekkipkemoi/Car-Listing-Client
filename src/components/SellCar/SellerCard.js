           ...
           <div className="row no-gutters">
            ...
            <div className="col-sm-7 col-md-7">
                ...
                <div className="card-body">
                    ...
                    <h5 className="card-title font-weight-bold" style={{color: "#009688"}}>{priceFormat(car.price)} <span className="font-weight-bold" style={{fontSize:"14px",color:"#ffa010"}}>{car.priceNegotiable ?"Negotiable" : null}</span></h5>
