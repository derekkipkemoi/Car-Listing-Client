      ...
      <div>
        <div className="container" style={{ marginTop: "100px" }}>
          ...
          <p>
            ...
            property rights related to it, still belong to MOTII CARS
            ENTERPRISES.
          </p>{" "}
          <p>
            MOTII CARS ENTERPRISES is committed to ensuring that the app is as
          ...
          <p>
            The Motii. Nunua / Uza Motii app stores and processes personal data
            ...
            mean that the Motii. Nunua / Uza Motii app won’t work properly or at
            all.
          </p>{" "}
          <div>
            <p>
          ...
          <p>
            You should be aware that there are certain things that MOTII CARS
            ENTERPRISES will not take responsibility for. Certain functions of
            ...
            provider, but MOTII CARS ENTERPRISES cannot take responsibility for
          ...
          <p>
            Along the same lines, MOTII CARS ENTERPRISES cannot always take
            ...
            you can’t turn it on to avail the Service, MOTII CARS ENTERPRISES
            cannot accept responsibility.
          </p>{" "}
          <p>
            With respect to MOTII CARS ENTERPRISES’s responsibility for your use
            ...
            information to us so that we can make it available to you. MOTII
            CARS ENTERPRISES accepts no liability for any loss, direct or
          ...
          <p>
            ...
            to keep using the app. MOTII CARS ENTERPRISES does not promise that
          ...
          <p>These terms and conditions are effective as of 2021-02-13</p>{" "}
          <p>
            <strong>Contact Us</strong>
          </p>{" "}
          <p>
            If you have any questions or suggestions about our Terms and
            Conditions, do not hesitate to contact us at info@motikenya.co.ke.
          </p>{" "}
        </div>
      </div>
    );
